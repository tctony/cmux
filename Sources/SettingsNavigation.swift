...
enum SettingsSearchIndex {
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.gitDiffJumpPreset": settingID(for: .app, idSuffix: "git-diff-jump"),
        "app.gitDiffJumpCommand": settingID(for: .app, idSuffix: "git-diff-jump"),
        "app.gitDiffJumpArguments": settingID(for: .app, idSuffix: "git-diff-jump"),
